...
import com.kab.channel66.MediaController.MediaPlayerControl;
...
public class VideoView extends SurfaceView implements  MediaPlayerControl {
	...
	private com.kab.channel66.MediaController mMediaController;
...
//			}
	...
	public void setMediaController(com.kab.channel66.MediaController mMediaController2) {
		if (mMediaController != null)
			mMediaController.hide();
		mMediaController = mMediaController2;
		attachMediaController();
	}
	...
	private OnErrorListener mErrorListener = new OnErrorListener() {
		public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
			//log.d("Error: %d, %d", framework_err, impl_err);
			 EasyTracker.getTracker().trackEvent("Video view", "error playing","frame work error",(long) framework_err);
