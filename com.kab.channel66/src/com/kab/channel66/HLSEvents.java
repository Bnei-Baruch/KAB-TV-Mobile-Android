...
public class HLSEvents {
	...
	public class Pages{
		...
		public Pages()
		{
			pages = new ArrayList<HLSEvents.Page>();
		}
	}
	//JSON Node names
	private static final String LOCALE = "localeHLS";
	...
	JSONObject mData;
	Context mContext;
	public HLSEvents(JSONObject data, Context context)
	{
		mData =  data;
		mContext = context;
	}
	...
	{
		try {
			locale = new HashMap<String, HLSEvents.Pages>();
			String text = null;
